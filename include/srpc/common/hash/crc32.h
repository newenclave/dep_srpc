#ifndef SRPC_COMMON_HASH_CRC32_H
#define SRPC_COMMON_HASH_CRC32_H
...
namespace srpc { namespace common { namespace hash {
    ...
    namespace traits {
        struct crc32 {
            static const srpc::uint32_t poly = 0xedb88320;
            static srpc::uint32_t get_value( std::uint32_t id )
            {
                /* poly 0xedb88320 */
                static const srpc::uint32_t crc_32_table[ ] = {
            ...
            static std::uint32_t update( srpc::uint32_t old, srpc::uint8_t val )
            {
